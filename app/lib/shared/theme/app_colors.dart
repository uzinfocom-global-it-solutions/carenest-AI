...
abstract final class AppColors {
  ...
  static const Color surface2 = Color(0xFFECECEF);
  static const Color card = Color(0xFFFFFFFF);

  static const Color ink = Color(0xFF0A0A0C);
  static const Color ink2 = Color(0xFF3A3A40);
  static const Color ink3 = Color(0xFF6E6E75);
  static const Color ink4 = Color(0xFFA1A1A8);

  static const Color line = Color(0x12000000);
  static const Color lineStrong = Color(0x24000000);

  static const Color blue = Color(0xFF2563FF);
  static const Color blue2 = Color(0xFF1D4ED8);
  static const Color blueSoft = Color(0xFFE8EFFF);
  static const Color blueInk = Color(0xFF0A2A6B);

  static const Color green = Color(0xFF1AAA6B);
  static const Color greenSoft = Color(0xFFE3F6ED);
  static const Color amber = Color(0xFFE0A400);
  static const Color amberSoft = Color(0xFFFBF3DA);
  static const Color red = Color(0xFFE0392C);
  static const Color redSoft = Color(0xFFFBE5E3);
  static const Color violet = Color(0xFF7C5CFF);
  static const Color violetSoft = Color(0xFFECE7FF);
